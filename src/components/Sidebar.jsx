  ...
  <div className="mt-10">
    {links.map((item) => (
      <NavLink
        ...
        className="flex flex-row justify-start items-center mx-3 my-7 text-sm text-gray-400 hover:text-cyan-300">
...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`absolute top-0 h-screen w-2/3 bg-gradient-to-tl from-white/10 to-[#483d8b] backdrop-blur-lg z-10 p-5
